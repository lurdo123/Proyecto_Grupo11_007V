...
public class globalExceptionHandler {
    ...
    // Maneja compatibilidad no encontrada (Reemplaza a AutenticacionNotFoundException)
    @ExceptionHandler(compatibilidadNotFoundException.class)
    public ResponseEntity<errorResponse> manejarCompatibilidadNoEncontrada(
            compatibilidadNotFoundException ex,
            HttpServletRequest request) {
